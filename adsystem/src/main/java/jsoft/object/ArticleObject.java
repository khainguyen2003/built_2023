...
public class ArticleObject {
	...
	public ArticleObject(String article_title, String article_summary, String article_content,
			String article_created_date, String article_last_modified, String article_image, short article_category_id,
			short article_section_id, short article_visited, String article_author_name, boolean article_enable,
			String article_url_link, String article_tag, String article_title_en, String article_summary_en,
			String article_content_en, String article_tag_en, int article_fee, boolean article_isfee,
			boolean article_delete, String article_deleted_date, String article_restored_date,
			String article_modified_author_name, byte article_author_permission, String article_source,
			byte article_language, boolean article_focus, byte article_type, boolean article_forhome, int section_id) {
