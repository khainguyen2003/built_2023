...
public class SectionObject {
	...
	public SectionObject(String section_name, String section_notes, String section_created_date, int section_manager_id,
			boolean section_enable, boolean section_delete, String section_last_modified,
			int section_created_author_id, String section_name_en, byte section_language, short section_id) {
