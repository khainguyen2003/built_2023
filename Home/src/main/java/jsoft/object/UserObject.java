...
public class UserObject {
	...
	public UserObject(int user_id, String user_name, String user_pass, String user_fullname, String user_birthday,
			...
			String user_last_modified, String user_last_logined, int user_parent_id, byte user_actions, boolean user_deleted, String user_images) {
		super();
