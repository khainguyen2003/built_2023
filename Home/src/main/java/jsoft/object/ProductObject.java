...
public class ProductObject {
	...
	private byte product_best_seller;
	private byte product_promotion;
	private short product_price_calc_description;
	private String product_size;
	private String product_name_en;
	private int product_customer_id;
	private byte product_perspective_id;
	
	public ProductObject() {
		super();
	}
	public ProductObject(String product_name, String product_image, int product_price, int product_discount_price,
			boolean product_enable, boolean product_delete, short product_visited, short product_total,
			int product_manager_id, String product_intro, String product_notes, String product_code,
			String product_created_date, String product_modified_date, short product_pc_id, short product_pg_id,
			short product_ps_id, boolean product_is_detail, String product_deleted_date, String product_deleted_author,
			int product_promotion_price, short product_sold, byte product_best_seller, byte product_promotion,
			short product_price_calc_description, String product_size, String product_name_en, int product_customer_id,
			byte product_perspective_id) {
		super();
	...
	public byte getProduct_best_seller() {
		return product_best_seller;
	}
	public byte getProduct_promotion() {
	...
	public byte getProduct_perspective_id() {
	...
	public void setProduct_best_seller(byte product_best_seller) {
		this.product_best_seller = product_best_seller;
	}
	public void setProduct_promotion(byte product_promotion) {
		this.product_promotion = product_promotion;
	}
	...
	public void setProduct_perspective_id(byte product_perspective_id) {
		this.product_perspective_id = product_perspective_id;
	}
