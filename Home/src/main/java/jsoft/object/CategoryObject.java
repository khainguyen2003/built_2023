...
public class CategoryObject extends SectionObject {
	...
	private short category_language;
	
	public CategoryObject() {
		super();
	}
	public CategoryObject(short category_id, String category_name, short category_section_id, String category_notes,
			String category_created_date, int category_created_author_id, String category_last_modified,
			int category_manager_id, boolean category_enable, boolean category_delete, String category_image,
			String category_name_en, short category_language) {
		super();
	...
	public short getCategory_language() {
	...
	public void setCategory_language(short category_language) {
		this.category_language = category_language;
	}
